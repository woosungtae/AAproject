...
function fn_check() {
    ...
    var roadAdd = document.getElementById("roadAdd");
    var jibunAdd = document.getElementById("jibunAdd");
    var namujiAdd = document.getElementById("namujiAdd");
...
function sendEmail() {
   ...
   var _email=$("#_email").val() + "@" + $("#email2").val();
    ...
    $.ajax({ //비동기통신 
       type:"post",
       url:"${contextPath}/member/overlappedEmail.do", //이메일 중복 검사 
       dataType:"text",
...
<body>  
   <img class="logo" alt="AA" width="680px" height="230px" src="${contextPath}/resources/image/loginForm.png">
   <form method="post" action="${contextPath}/member/addMember.do" name="join">
      <table class="member">
         <tr class="field">
              <th><b>아이디</b><span> *</span></th>
              <td><input type="text" name="_member_id" id="_member_id" class="member_id"/><input type="hidden" name="id"  id="id" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="btnOverlapped" value="중복확인" onClick="fn_overlapped()"/></td>
          </tr>
              <tr class="field">
              ...
              <tr class="field">
                  ...
                  <td><input type="text" name="nickname" class="name" id="nickName"></td>
              </tr>
              <tr class="field">
                  <th><b>주민등록번호</b><span> *</span></th> 
                  <td><input type="text" name="jumin1" class="jumin1" id="jumin1">&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;<input type="password"name="jumin2" class="jumin2" id="jumin2"></td>
              </tr>      
               <tr class="field">     
              ...
              <tr class="field">
                 <td></td>
                 <td><input type="checkbox" id="emailsts_yn" name="emailsts_yn" value="true" checked><label for="emailsts_yn" class="hi">&nbsp;AA에서 발송하는 email을 수신합니다.</label></td>
              </tr>
               <tr class="field">
                    <th><b>인증번호입력</b></th>
              ...
              <tr class="field">
                  ...
                  <td><input type="text" name="tel" placeholder="하이픈(-) 없이 입력하세요" class="phone" id="tel"></td>
              </tr>
              <tr class="field">
                 <td></td>
                 <td><input type="checkbox" id="smssts_yn" name="smssts_yn" value="true" checked><label for="smssts_yn" class="hi">&nbsp;AA에서 발송하는 SMS를 수신합니다.</label></td>
              </tr>
            <tr class="field">
            <th></th>
            <td><input type="text" id="zipcode" name="zipcode" size="15" placeholder="우편번호">
            &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="우편번호검색" onclick="execDaumPostcode()"></td>
              </tr>
             <tr class="field"> 
             <th>주소</th>
             <td><input type="text" id="roadAdd"  name="roadAdd" size="70" style="width:310px;" placeholder="도로명 주소"></td>
             </tr>   
             <tr class="field"> 
             <th></th> 
             <td style="width:470px;"><input type="text" id="jibunAdd" name="jibunAdd" size="70" style="width:310px;" placeholder="지번 주소">&nbsp;<input type="text" id="namujiAdd" name="namujiAdd" size="50" style="width:120px;" placeholder="상세 주소"></td>
             </tr>
              </table> 
              <div> 
             <tr>
             <td> 
             <input type="button"  value="회원 가입" id="check" onClick="fn_check()" class="bottom1">
             <input  type="reset"  value="다시입력" class="bottom2">
             </td>
             </tr>
           </div>
        </form>
