...
<body>
	<form  method="post"enctype="multipart/form-data" autocomplete="off">
		<h3 style="font-size:2em;height:60px; margin-left:300px; margin-right:auto;">상품 수정</h3>
		...
		<!-- 내용 들어 가는 곳 -->
			<ul class="addNewGoodsForm">
				...
				<li style="text-align: center;"><input type="button" value="수정" onClick="fn_add_new_goods(this.form)" class="goods_button"></li>
		</ul>
	</form>
</body>
</html>