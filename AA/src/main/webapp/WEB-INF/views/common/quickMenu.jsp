...
<body>    
   ...
   <div class="recent"> 
    ...
    <c:choose>
       <c:when test="${ empty quickGoodsList }">
          <h5 style="margin-left:15px;">  &nbsp; &nbsp; &nbsp; &nbsp;  0/0  &nbsp; </h5>
       </c:when>
       <c:otherwise>
           <h5 style="margin-left:15px;"><a  href='javascript:fn_show_previous_goods();'> 이전 </a> &nbsp;  <span id="cur_goods_num">1</span>/${quickGoodsListNum}  &nbsp; <a href='javascript:fn_show_next_goods();'> 다음 </a> </h5>
       </c:otherwise>
       </c:choose>
    </div>
</div>
