...
<a href="${contextPath}/main/main.do">
	<img width="150px"  height="150px" alt="AA" src="${contextPath}/resources/image/logo_1.png" />
</a>
</div>
<div class="text">
...
<div class="center">
	<ul style="text-align: center;">
		...
		(점심시간 13:00~14:00)<br>
		주말, 공휴일 휴무</p>
		<a href="${contextPath}/cs/csListItems.do"><input type="button" value="1:1 문의" /></a>
	</ul>
</div>
<div class="help">
	<ul>
		<h3>지원</h3><br>
		<li><a href="${contextPath}/adboard/listItems.do">공지사항</a></li>
