...
<body> 
<h3 style="font-size:2em;width:900px; height:60px; margin-left:300px; margin-right:auto;">문의 내역</h3>
...
<c:choose>
  <c:when test="${memCsListItems ==null }" >
    <tr>  
      <td colspan="5">  
         <p align="center">
  ...
  <c:when test="${memCsListItems !=null }" >
    <c:forEach  var="csItem" items="${memCsListItems }" varStatus="csItemNum" >
