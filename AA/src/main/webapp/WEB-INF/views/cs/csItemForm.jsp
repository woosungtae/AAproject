...
<body>
<h3 style="font-size:2em;width:900px; height:60px; margin-left:300px; margin-right:auto;">문의 글 작성</h3>
<table  width=900px;   class="list_view" style=" margin-left:280px;">
</table>
  <form name="itemForm" method="post"   action="${contextPath}/cs/csAddNewItem.do"   enctype="multipart/form-data"  style="margin-left:200px;">
    <table border="0" align="center" style="margin-left:100px;">
      <tr>
			<td align="center"> 작성자</td>
			<c:choose>
				<c:when test="${companyInfo.id != null}">
				  <td colspan=2 align="left"><input type="text" size="20" maxlength="100" style="height:30px;" value="${companyInfo.id}" readonly/></td>
				</c:when>
				<c:when test="${memberInfo.id != null}">
				  <td colspan=2 align="left"><input type="text" size="20" maxlength="100" style="height:30px;" value="${memberInfo.id}" readonly/></td>
				</c:when>
			</c:choose>
			</tr>
			<tr>
            <td align="center">글 제목: </td>
            	<td colspan="2"><input type="text" size="72.8"  maxlength="500" style="height:30px;" name="cs_title" /></td>
       		</tr> 
			<tr>
			   ...
			   <td colspan="2">
					<select name="cs_category">
						...
						<option value="계정/보안">기타</option>
					</select>
				</td>
		 </tr>
	 		<tr>
				<td align="center" valign="top"><br>글내용: </td>
				<td colspan=2><textarea name="cs_content" style="width:540px;" rows="10" cols="65" maxlength="4000"></textarea> </td>
     </tr>
     <tr>
