...
<body>
	<h3 style="font-size:2em;width:900px; height:60px; margin-left:300px; margin-right:auto;">상품 조회</h3>
   ...
   <c:choose>
     ...
     <c:forEach var="item" items="${newGoodsList }">
			 <TR>       
				...
				<TD >
				 <a href="${pageContext.request.contextPath}/goods/goodsDetail.do?goods_num=${item.goods_num}">
