...
<body>
<h3 style="font-size:2em;width:900px; height:60px; margin-left:300px; margin-right:auto;">My 게시글 조회</h3>
<table align="center" border="1"  width="80%" class="list_view">
  <tr height="10%" align="center" >
  	<td id="topz" style="font-size:0.8em;">글번호</td>
...
<c:choose>
  <c:when test="${memArticleList ==null }" >
    <tr>  
      <td colspan="6">  
         <p align="center">
  ...
  <c:when test="${memArticleList !=null }" >
    <c:forEach  var="article" items="${memArticleList }" varStatus="articleNum" >
