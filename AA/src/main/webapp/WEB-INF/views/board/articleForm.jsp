...
<body>
<h3 style="font-size:2em;width:900px; height:60px; margin-left:300px; margin-right:auto;">자유게시판 글 작성</h3>
<table  width=900px;   class="list_view" style=" margin-left:280px;"> 
</table>
  <form name="articleForm" method="post"   action="${contextPath}/board/addNewArticle.do"   enctype="multipart/form-data" style="margin-left:200px;">
    <table border="0" align="center" style="margin-left:100px;">
      <tr>
        ...
        <tr>
            ...
            <td colspan="2"><input type="text" size="72.8"  maxlength="500" style="height:30px;" name="board_title" /></td>
       </tr> 
        
          <tr>  
            <td align="center" valign="top"><br>글 내용: </td>
              <td colspan=2><textarea name="board_content" style="width:540px;" rows="10" cols="65" maxlength="4000"></textarea> </td>
           </tr>
