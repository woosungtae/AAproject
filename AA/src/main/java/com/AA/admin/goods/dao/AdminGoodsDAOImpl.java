package com.AA.admin.goods.dao;
...
public class AdminGoodsDAOImpl  implements AdminGoodsDAO{
	...
	public int insertNewGoods(Map newGoodsMap) throws DataAccessException {
		...
		return Integer.parseInt((String)newGoodsMap.get("goods_num"));
	}
	...
	public GoodsVO selectGoodsDetail(int goods_num) throws DataAccessException{
		...
		goodsBean=(GoodsVO)sqlSession.selectOne("mapper.admin.goods.selectGoodsDetail",goods_num);
		return goodsBean;
	}
	
	@Override
	public List selectGoodsImageFileList(int goods_num) throws DataAccessException {
		List imageList=new ArrayList();
		imageList=(List)sqlSession.selectList("mapper.admin.goods.selectGoodsImageFileList",goods_num);
		return imageList;
	}
	...
	public List<OrderVO> selectOrderGoodsList(Map condMap) throws DataAccessException{
		List<OrderVO>  orderGoodsList=(ArrayList)sqlSession.selectList("mapper.admin.goods.selectOrderGoodsList",condMap);
